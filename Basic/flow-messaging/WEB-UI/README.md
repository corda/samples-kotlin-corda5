...
A UI that talks to the Corda5-SolarSystem Cordapp: https://github.com/corda/corda5-solarsystem-flows-demo
...
In the project directory (c5-solarsystem-flows-demo-ui) run the following:
